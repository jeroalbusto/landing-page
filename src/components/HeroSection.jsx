    ...
    return (
        <section className="hero-section text-center mt-32 flex flex-col">
            ...
            <h2 className="mt-5 text-gray-600 sm:text-xl">
                Nexx is an open-source tool for developers who want to lunch their ideas faster.
            </h2>
            <div className="mx-auto mt-5 flex max-w-fit space-x-4">
                ...
                <a href="#features" className="rounded-full mx-auto max-w-fit border px-5 py-2 text-sm font-medium shadow-sm border-gray-200 bg-white text-black hover:ring-gray-300 hover:ring-2">
                    Learn More
                </a>
            </div>
